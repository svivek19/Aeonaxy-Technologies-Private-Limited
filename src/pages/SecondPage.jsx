    ...
    <div className="w-11/12 my-3 md:my-0 md:w-5/6 mx-auto space-y-10 text-center items-center flex justify-center flex-col">
      <div className="mt-10">
        ...
        <p className="text-slate-700">
          Choose just one. This will help us get you started{" "}
          {`(but won't limit your experience).`}
        </p>
      </div>

      <div className="w-11/12 md:w-1/2">
        <ul className="space-y-4 flex flex-col text-start">
          <li className="border flex items-center text-sm md:text-base space-x-2 border-slate-300 py-3 px-5 rounded-md w-full ">
            <div>
              <img src={trend} alt="" width={40} />
            </div>
            <div>Learning specific skills to advance my career</div>
          </li>
          <li className="border border-slate-300 text-sm md:text-base  py-3 px-5 flex items-center space-x-2 rounded-md w-full">
            <div>
